...
const primaryNavConfig = [
  ...
  { href: "Cantieri", icon: Building2, label: "Cantieri", perm: "cantieri_view" },
  { href: "Imprese", icon: Briefcase, label: "Imprese", perm: "imprese_view" },
  { href: "PersoneEsterne", icon: Users, label: "Professionisti", perm: "persone_view" },
  { href: "Subappalti", icon: Handshake, label: "Subappalti", perm: "subappalti_view" },
  { href: "Costi", icon: DollarSign, label: "Costi", perm: "costi_view" },
  { href: "SAL", icon: BarChart3, label: "SAL", perm: "sal_view" },
  { href: "AttivitaInterne", icon: ClipboardList, label: "Attività Interne", perm: "attivita_view" },
  { href: "Documenti", icon: FileText, label: "Documenti", perm: "documenti_view" },
  { href: "Cronoprogramma", icon: Calendar, label: "Cronoprogramma", perm: "cronoprogramma_view" },
